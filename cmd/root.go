...
var (
	useCustomTemplate                  bool                   // select custom backend/frontend templates
	askBecomePass                      bool                   // install Ansible roles, ask become pass
	options                            []string               // command options for `deploy`
	createAnswers, customCreateAnswers registry.CreateAnswers // answers for the `create` command
